...
We then look at the prevalence of obesity in each age group, ranging from ages 16 to 99. We can see in @fig-fig1 that as age increases, obesity rates increase, up to the age of around 65. After this point, obesity rates start to fall, which makes sense, as those who aren't obese will live longer on average. We also see that at the extreme upper ages, the obesity rates are 0, however there are significantly fewer samples which should be taken into account.

![Proportions of Obesity by Age](images/age.png){#fig-fig1 fig-align="center"}
...
![Obesity Proportion by Veg Intake](images/veg%20intake.png){#fig-fig2 fig-align="center" width="550"}

![Obesity Proportion by Fruit Intake](images/fruit%20intake.png){#fig-fig3 fig-align="center" width="550"}
...
![Obesity Proportion by Education](images/education.png){#fig-fig4 fig-align="center"}

Lastly, in @fig-fig5, we can see that obesity rates for males are about 2.3% lower than for females.

![Obesity Proportion by Sex](images/sex.png){#fig-fig5 fig-align="center" width="700"}
